...
/**
 *  @title Phaser
 *  @dev This contract provides functionality for minting, burning, and managing Phaser Banner NFTs.
 *  @notice ERC721 token contract representing the Phaser Banners token.
 */
...
contract BannerNFT is ERC721, ERC721Burnable, ERC721Enumerable, Ownable {
     ...
     */
    constructor(address initialOwner, address _verifier) ERC721("Phaser Banners", "BLCK") Ownable(initialOwner) {
