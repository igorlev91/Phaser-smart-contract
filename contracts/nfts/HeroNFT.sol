...
/**
 * @title Phaser
 * @dev This contract provides functionality for minting, burning, and managing Phaser Hero NFTs.
 * @notice ERC721 token contract representing the Phaser Heroes token.
 */
